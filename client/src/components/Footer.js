        ...
        <div className="footer-section-wrapper">
            <div className="footer-section">
                ...
                <nav className="footer-list">
                    <li>
                        <a href="#" className="footer-link">First Link</a>
                    </li>
                    <li>
                        <a href="#" className="footer-link">Second Link</a>
                    </li>
                    <li>
                        <a href="#" className="footer-link">Third Link</a>
                    </li>
                    <li>
                        <a href="#" className="footer-link">Fourth Link</a>
                    </li>
                </nav>
            </div>
            <div className="footer-section">
        ...
        <div className="footer-bottom">
            <div className="footer-bottom-container">
                ...
                <div className="footer-social">
                    <a href="https://github.com/206Dorian/Didactic-Lift" className="footer-social-icon">    
